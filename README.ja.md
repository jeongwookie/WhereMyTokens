...
- **Code Output** — git ベースの生産性指標：コミット数、純変更行数、$/コミット（today/all time 切り替え）
...
1. [Releases](https://github.com/jeongwookie/WhereMyTokens/releases) から `WhereMyTokens-v1.4.0-win-x64.zip` をダウンロード
2. ZIP を展開
