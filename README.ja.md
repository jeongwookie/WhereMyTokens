...
| **[v1.8.0](https://github.com/jeongwookie/WhereMyTokens/releases/tag/v1.8.0)** | 4/17 | ヘッダー today/all トグル、$/100 Lines 指標、Rhythm コストベースタブ |
...
1. `WhereMyTokens-Setup.exe` をダウンロード
