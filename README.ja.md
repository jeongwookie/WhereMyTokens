...
- **アクティビティタブ** — 7 日間ヒートマップ、5 ヶ月カレンダー（GitHub スタイル）、時間帯別分布、4 週間比較、**Rhythm**（30 日間の時間帯別コスト分布、ピーク表示）
...
| Rhythm | 時間帯別コスト分布 — Morning ☀️ / Afternoon 🔥 / Evening 🌆 / Night 🌙、ピーク表示（30 日間、ローカルタイムゾーン） |
