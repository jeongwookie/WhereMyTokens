...
| 버전 | 날짜 | 주요 변경 |
|------|------|-----------|
| v1.19.1 | 2026-06-22 | Fix Claude JSONL discovery so agent logs contribute to recent usage graphs, visible startup sessions still hide agent-only logs, and project discovery scans later JSONL files instead of depending on the first filename |
