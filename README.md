...
<p align="center">
  ...
  <a href="https://github.com/jeongwookie/WhereMyTokens/releases/tag/v1.24.1"><img alt="Release v1.24.1" src="https://img.shields.io/badge/release-v1.24.1-2563eb?style=for-the-badge"></a>
...
|----------|----------|----------|
| Windows 10/11 | **[Installer (.exe)](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.24.1/WhereMyTokens-Setup.exe)** | Normal installation, auto-start from the tray |
| Windows 10/11 — 日本語 UI | **[Japanese UI installer](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.24.1/WhereMyTokens-Setup.exe)** | Same installer; Japanese Windows opens in Japanese automatically, or choose Settings → General → Language |
| Windows 10/11 | **[Portable ZIP](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.24.1/WhereMyTokens-v1.24.1-win-x64.zip)** | No installer, keep it anywhere |
