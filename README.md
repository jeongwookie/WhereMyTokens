...
<p align="center">
  ...
  <a href="https://github.com/jeongwookie/WhereMyTokens/releases/tag/v1.19.2"><img alt="Release v1.19.2" src="https://img.shields.io/badge/release-v1.19.2-2563eb?style=for-the-badge"></a>
...
|----------|----------|----------|
| Windows 10/11 | **[Installer (.exe)](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.19.2/WhereMyTokens-Setup.exe)** | Normal installation, auto-start from the tray |
| Windows 10/11 | **[Portable ZIP](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.19.2/WhereMyTokens-v1.19.2-win-x64.zip)** | No installer, keep it anywhere |
