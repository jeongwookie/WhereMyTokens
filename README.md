...
<p align="center">
  <a href="https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.18.1/WhereMyTokens-Setup.exe"><strong>Download v1.18.1</strong></a>
  ·
...
<p align="center">
  <em>v1.18.1 stabilizes Antigravity quota pacing, account masking, and startup history sync.</em>
</p>
...
**[⬇ Download Installer (.exe)](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.18.1/WhereMyTokens-Setup.exe)** - just run and done

**[⬇ Download Portable ZIP](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.18.1/WhereMyTokens-v1.18.1-win-x64.zip)** - no install required
...
1. Download `WhereMyTokens-v1.18.1-win-x64.zip` from the release page
