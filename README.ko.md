...
1. [Releases](https://github.com/jeongwookie/WhereMyTokens/releases)에서 `WhereMyTokens-v1.7.1-win-x64.zip` 다운로드
2. ZIP 압축 해제
...
- **Breakdown 버튼** — 카테고리별 토큰 사용 분석 패널 토글 (Read / Edit/Write / Search / Git / Build/Test / Terminal / Subagents / Thinking / Response), 한 번에 하나만 열림
...
세션 행의 **Breakdown** 버튼을 클릭하면 해당 세션의 카테고리별 output 토큰 분석 패널이 펼쳐집니다. 한 번에 하나만 열리며, 다른 세션을 클릭하면 이전 패널이 자동으로 닫힙니다.
