...
**[⬇ 인스톨러 다운로드 (.exe)](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.10.0/WhereMyTokens-Setup.exe)** — 받아서 실행하면 끝
...
1. 릴리즈 페이지에서 `WhereMyTokens-v1.10.0-win-x64.zip` 다운로드
2. 원하는 위치에 압축 해제
