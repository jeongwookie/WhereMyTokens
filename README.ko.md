...
<p align="center">
  <a href="https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.24.1/WhereMyTokens-Setup.exe"><strong>v1.24.1 다운로드</strong></a>
  ·
...
<p align="center">
  <em>v1.24.1은 최신 statusLine이 없어도 기존 Claude Code credential이 있으면 Claude Desktop 사용 중 quota를 읽기 전용 호환 fallback으로 복구하며, credential 갱신과 쓰기는 계속 금지합니다.</em>
</p>
...
**[⬇ 인스톨러 다운로드 (.exe)](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.24.1/WhereMyTokens-Setup.exe)** — 받아서 실행하면 끝
...
**[⬇ 포터블 ZIP 다운로드](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.24.1/WhereMyTokens-v1.24.1-win-x64.zip)** — 설치 없이 실행
...
1. 릴리즈 페이지에서 `WhereMyTokens-v1.24.1-win-x64.zip` 다운로드
2. 원하는 위치에 압축 해제
