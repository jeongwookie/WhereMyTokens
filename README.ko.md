...
<p align="center">
  <a href="https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.21.0/WhereMyTokens-Setup.exe"><strong>v1.21.0 다운로드</strong></a>
  ·
...
<p align="center">
  <em>v1.21.0은 사용량 저장소를 source 귀속 SQLite UsageIndex로 통합하고, Reset index 복구와 taskbar mini hit bounds를 개선합니다.</em>
</p>
...
1. 릴리즈 페이지에서 `WhereMyTokens-v1.21.0-win-x64.zip` 다운로드
2. 원하는 위치에 압축 해제
