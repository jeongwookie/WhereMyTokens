...
<p align="center">
  <a href="https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.19.2/WhereMyTokens-Setup.exe"><strong>v1.19.2 다운로드</strong></a>
  ·
...
<p align="center">
  <em>v1.19.2는 짧은 Claude thinking 블록에서도 Trend breakdown import가 안정적으로 유지되도록 보강합니다.</em>
</p>
...
**[⬇ 인스톨러 다운로드 (.exe)](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.19.2/WhereMyTokens-Setup.exe)** — 받아서 실행하면 끝

**[⬇ 포터블 ZIP 다운로드](https://github.com/jeongwookie/WhereMyTokens/releases/download/v1.19.2/WhereMyTokens-v1.19.2-win-x64.zip)** — 설치 없이 실행
...
1. 릴리즈 페이지에서 `WhereMyTokens-v1.19.2-win-x64.zip` 다운로드
2. 원하는 위치에 압축 해제
