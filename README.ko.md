...
| **[v1.8.0](https://github.com/jeongwookie/WhereMyTokens/releases/tag/v1.8.0)** | 4/17 | 헤더 today/all 토글, $/100 Lines 지표, Rhythm 비용 기반 탭 |
...
1. `WhereMyTokens-v1.9.1-win-x64.zip` 다운로드
2. 원하는 위치에 압축 해제
